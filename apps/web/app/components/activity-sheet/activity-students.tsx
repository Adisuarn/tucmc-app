        ...
        render={arrayHelpers => (
          <div className="space-y-6">
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="col-span-2 sm:col-span-1">
                    ...
                    >
                      <SelectTrigger className={getFieldError(index, 'title') ? 'border-red-500' : ''}>
            ...
            <button
              ...
              className="w-full py-4 border-2 border-dashed rounded-lg text-gray-500 hover:bg-gray-50 transition-colors"
            >
